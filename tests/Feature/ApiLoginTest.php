...
test('valid user with mismatched pubkey cannot log in', function () {
    $nonce = '49c2050ff9587680beab656ac74b361cfc67753208169bdef43c135240738ccf';
    Nonce::factory()->create(['nonce' => $nonce, 'pubkey' => '1234567890']);
...
test('valid user with mismatched device_name cannot log in', function () {
    $nonce = '49c2050ff9587680beab656ac74b361cfc67753208169bdef43c135240738ccf';
    Nonce::factory()->create(['nonce' => $nonce, 'device_name' => '23fasdfasdf']);
    $this->assertDatabaseCount('nonces', 1);
    $this->withoutExceptionHandling();
